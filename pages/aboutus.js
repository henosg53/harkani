    ...
    return(
       <div id="about_us" className="w-full h-fit">
         <div className="w-full   min-h-[650px] ">
           ...
           <div className="bg-secondary bg-cover pt-24 lg:hidden md:hidden justify-self-center h-[700px]  w-full">
             <span>
             <span className='font-semibold  flex flex-col py-24  px-10   w-[100%] h-inherit'>
           ...
           <div className=" bg-slate-700 hidden pt-24 px-10 py-10 sm:flex h-[600px] w-full">
